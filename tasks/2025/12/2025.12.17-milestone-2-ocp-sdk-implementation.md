...
See [ADR-002: Cap Table Replication & Verification](https://github.com/Fairmint/canton/blob/main/docs/developer/adr/002-state-verification.md) for the detailed verification architecture.
...
- Production replication services ([Milestone 3a: Cap Table Replication](https://github.com/Fairmint/canton/blob/main/tasks/2025/12/2025.12.17-milestone-3a-cap-table-replication.md))
- Ongoing drift monitoring ([Milestone 3b: Drift Monitoring & Alerting](https://github.com/Fairmint/canton/blob/main/tasks/2025/12/2025.12.17-milestone-3b-drift-monitoring.md))

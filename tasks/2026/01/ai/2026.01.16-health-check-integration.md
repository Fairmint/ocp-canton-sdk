...
1. **Add health check methods**:
   ...
   export async function checkHealth(options?: HealthCheckOptions): Promise<ServiceHealth>;
   ```
...
1. **Add wait-for-ready utility**:
   ...
   export async function waitForReady(options?: WaitForReadyOptions): Promise<ServiceHealth>;
   ```

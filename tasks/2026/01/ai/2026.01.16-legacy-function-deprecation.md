...
**Date**: 2026-01-16 **Status**: Open **Priority**: Low **Depends On**:
...
- [ ] Add `@deprecated` JSDoc to all legacy `buildCreate*Command` functions
- [ ] Add `@deprecated` JSDoc to all legacy `buildEdit*Command` functions
- [ ] Add `@deprecated` JSDoc to all legacy `buildDelete*Command` functions
- [ ] Update TypeDoc configuration to show deprecation warnings

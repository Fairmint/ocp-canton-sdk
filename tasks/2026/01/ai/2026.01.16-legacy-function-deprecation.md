...
### Phase 1: Remove Legacy Exports

- [x] Remove public exports of all `*DataToDaml` functions from index files (20 functions)
- [x] Functions remain for internal use by batch API only
- [ ] ~~Add `@deprecated` JSDoc~~ - Not needed, exports removed entirely
...
| 2026-01-20 | Removed public exports of all 20 \*DataToDaml functions        | --  |

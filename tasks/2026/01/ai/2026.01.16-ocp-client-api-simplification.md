...
- [x] Add `OcpClientContext` interface
- [x] Add `setContext()` and `getContext()` methods
- [ ] Update methods to use cached context as fallback (deferred - requires broader API changes)
- [ ] Add tests for context caching (deferred - requires broader API changes)

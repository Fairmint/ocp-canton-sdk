...
- [x] Add unit tests for converters (fixture + OcpClient wiring)
- [ ] Add integration test via batch API

### EquityCompensationTransfer

- [x] Add `toEquityCompensationTransfer` converter in `ocfToDaml.ts` (already exists)
- [x] Add `fromEquityCompensationTransfer` converter for DAML → OCF (`getEquityCompensationTransferAsOcf.ts`)
- [x] Add unit tests for converters (fixture + OcpClient wiring)
- [ ] Add integration test via batch API

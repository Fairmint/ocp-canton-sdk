...
Add support for Canton Network observability patterns including correlation identifiers for
debugging, structured logging integration, and trace propagation across SDK operations.

## Background

The Canton Network documentation emphasizes the importance of correlation identifiers for debugging
and monitoring distributed applications. Key identifiers include:

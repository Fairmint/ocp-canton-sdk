...
| Type               | Description                      | DAML Support | Priority |
| ------------------ | -------------------------------- | ------------ | -------- |
...
- [ ] Add `toValuation` converter in `ocfToDaml.ts`
- [ ] Add `fromValuation` converter for DAML → OCF
- [ ] Add unit tests for converters
- [ ] Add integration test via batch API

### VestingStart

- [ ] Add `toVestingStart` converter in `ocfToDaml.ts`
- [ ] Add `fromVestingStart` converter for DAML → OCF
- [ ] Add unit tests for converters
- [ ] Add integration test via batch API

### VestingEvent

- [ ] Add `toVestingEvent` converter in `ocfToDaml.ts`
- [ ] Add `fromVestingEvent` converter for DAML → OCF
- [ ] Add unit tests for converters
- [ ] Add integration test via batch API

### VestingAcceleration

- [ ] Add `toVestingAcceleration` converter in `ocfToDaml.ts`
- [ ] Add `fromVestingAcceleration` converter for DAML → OCF
- [ ] Add unit tests for converters
- [ ] Add integration test via batch API

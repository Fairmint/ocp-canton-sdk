...
├── 2025/
│   └── 12/
│       ├── 2025.12.17-milestone-2-ocp-sdk-implementation.md  # Parent milestone task
│       ├── 2025.12.30-comprehensive-integration-tests.md     # Complete
│       └── 2025.12.31-canton-3.4-upgrade.md                  # Complete
└── 2026/
    └── 01/
        ├── 2026.01.14-personalairdrop-amulet-rules-override.md  # Complete
        └── ai/                                                  # AI-tracked subtasks
            ├── 2026.01.02-library-refactoring-and-testing.md
            ├── 2026.01.08-remaining-integration-tests.md        # Closed
            ...
            └── 2026.01.16-type-guards-for-ocf-objects.md        # Complete
```

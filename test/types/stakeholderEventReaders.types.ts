/** Exact source contracts for stakeholder event readers, writers, operations, batches, and OcpClient. */
...
} from '../../src/functions/OpenCapTable/stakeholderRelationshipChangeEvent/damlToOcf';
import type { GetStakeholderRelationshipChangeEventAsOcfResult } from '../../src/functions/OpenCapTable/stakeholderRelationshipChangeEvent/getStakeholderRelationshipChangeEventAsOcf';
...
import type { GetStakeholderStatusChangeEventAsOcfResult } from '../../src/functions/OpenCapTable/stakeholderStatusChangeEvent/getStakeholderStatusChangeEventAsOcf';
...
// @ts-expect-error exact optional relationship fields cannot be explicitly undefined
...
const writerDispatcherAndOperationTypesAreExact: Assert<
  EveryTrue<
    [
...
const clientTypesAreExact: Assert<
  ...
  >
> = true;
const generatedPayloadTypesAreExact: Assert<
  EveryTrue<
    [
      IsExactly<
...
void invalidStatus;
void writerDispatcherAndOperationTypesAreExact;
void batchTypesAreExact;
void clientTypesAreExact;
void generatedPayloadTypesAreExact;

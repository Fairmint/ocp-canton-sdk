/** Built-declaration contracts for the six exact canonical conversion-trigger variants. */
...
// @ts-expect-error built condition variants forbid date fields
...
// @ts-expect-error built automatic date variants require trigger_date
...
// @ts-expect-error built automatic date variants forbid conditions
...
// @ts-expect-error built range variants require both boundaries
...
// @ts-expect-error built payloadless variants forbid every timing field

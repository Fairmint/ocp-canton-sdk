/** Built-declaration contracts for conversion and exercise readers and converters. */
...
} from '../../dist/functions/OpenCapTable/convertibleConversion/damlToOcf';
import type { GetConvertibleConversionAsOcfResult } from '../../dist/functions/OpenCapTable/convertibleConversion/getConvertibleConversionAsOcf';
import type {
  DamlEquityCompensationExerciseData,
  damlEquityCompensationExerciseDataToNative,
  GetEquityCompensationExerciseAsOcfResult,
} from '../../dist/functions/OpenCapTable/equityCompensationExercise/getEquityCompensationExerciseAsOcf';
import type {
  DamlStockConversionData,
  damlStockConversionToNative,
} from '../../dist/functions/OpenCapTable/stockConversion/damlToOcf';
import type { GetStockConversionAsOcfResult } from '../../dist/functions/OpenCapTable/stockConversion/getStockConversionAsOcf';
import type {
  DamlWarrantExerciseData,
  damlWarrantExerciseToNative,
} from '../../dist/functions/OpenCapTable/warrantExercise/damlToOcf';
import type { GetWarrantExerciseAsOcfResult } from '../../dist/functions/OpenCapTable/warrantExercise/getWarrantExerciseAsOcf';
...
// @ts-expect-error built convertible results cannot be used as stock conversions
const wrongStockEvent: OcfStockConversion = convertibleResult.event;
// @ts-expect-error built stock results cannot be used as convertible conversions
const wrongConvertibleEvent: OcfConvertibleConversion = stockResult.event;
// @ts-expect-error built equity-compensation results cannot be used as warrant exercises
const wrongWarrantEvent: OcfWarrantExercise = equityCompensationResult.event;
// @ts-expect-error built warrant results cannot be used as equity-compensation exercises
const wrongEquityCompensationEvent: OcfEquityCompensationExercise = warrantResult.event;
// @ts-expect-error built convertible DAML cannot be passed to the stock converter
const wrongStockDaml: StockInput = convertibleDaml;
// @ts-expect-error built stock DAML cannot be passed to the convertible converter
const wrongConvertibleDaml: ConvertibleInput = stockDaml;
// @ts-expect-error built equity-compensation DAML cannot be passed to the warrant converter
const wrongWarrantDaml: WarrantInput = equityCompensationDaml;
// @ts-expect-error built warrant DAML cannot be passed to the equity-compensation converter

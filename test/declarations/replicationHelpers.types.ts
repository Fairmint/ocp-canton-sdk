...
const stakeholderData: ReadonlyMap<string, OcfStakeholder> | undefined = cantonData.get('stakeholder');
...
declare const widenedData: CantonOcfDataEntry<'stakeholder' | 'stockClass'>[1];

...
function terminationWindowToDaml(
  w: TerminationWindow
): Fairmint.OpenCapTable.Types.OcfTerminationWindow {
...
function equityCompIssuanceDataToDaml(
  d: OcfEquityCompensationIssuanceData
): Fairmint.OpenCapTable.Types.OcfEquityCompensationIssuanceData {
  return {

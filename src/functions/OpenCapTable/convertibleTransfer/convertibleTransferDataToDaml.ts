...
export function convertibleTransferDataToDaml(d: OcfConvertibleTransfer): DamlConvertibleTransferOutput {
  ...
  const result = {
    ...
    amount: positiveTransferMonetaryToDaml(input.amount, `${path}.amount`),

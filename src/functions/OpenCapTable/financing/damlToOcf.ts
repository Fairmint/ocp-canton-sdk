...
export function damlFinancingToNative(
  financing: Fairmint.OpenCapTable.OCF.Financing.FinancingOcfData,
  source = 'financing'
): OcfFinancing {
  return {
    object_type: 'FINANCING',
    id: financing.id,
    date: damlTimeToDateString(financing.date, `${source}.date`),
    name: financing.name,

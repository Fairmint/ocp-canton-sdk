 ...
 *
 *   The CapTable contract has 2 signatories (issuer and system operator), so the standard Archive choice cannot be
 *   exercised by a single party. Archiving a CapTable requires coordination between both signatories.
 *
 *   For deleting individual entities within a cap table, use the appropriate delete function (e.g.,
 *   buildDeleteStakeholderCommand, buildDeleteStockClassCommand, etc.) which use the CapTable's Delete* choices.

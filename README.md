...
This README is for SDK contributors and AI assistants. Consumer-facing documentation, hosted site
URLs, and publishing notes live on the
...
- Contributor guidance lives in this README
- End-user docs and hosted site: [wiki Home](https://github.com/fairmint/ocp-canton-sdk/wiki) and
  [Docs site](https://github.com/fairmint/ocp-canton-sdk/wiki/Docs-Site)

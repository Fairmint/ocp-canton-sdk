...
Breaking changes by version: **`CHANGELOG.md`** (e.g. v0.4.0 removes payment-stream / coupon-minter
helpers from this package; use injected ledger/validator for those flows).
